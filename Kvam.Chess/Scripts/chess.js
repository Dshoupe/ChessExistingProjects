(function (chessEngine, $, undefined) {
    var
        ...
        setup = function (gameSettings) {
            if (gameSettings.is906 === true) {
                var split = gameSettings.holder.split("-");
                boardConfiguration = {
                    'a1': 'w' + split[0], 'b1': 'w' + split[1], 'c1': 'w' + split[2], 'd1': 'w' + split[3], 'e1': 'w' + split[4], 'f1': 'w' + split[5], 'g1': 'w' + split[6], 'h1': 'w' + split[7],
                    'a2': 'wp', 'b2': 'wp', 'c2': 'wp', 'd2': 'wp', 'e2': 'wp', 'f2': 'wp', 'g2': 'wp', 'h2': 'wp',
                    'a7': 'bp', 'b7': 'bp', 'c7': 'bp', 'd7': 'bp', 'e7': 'bp', 'f7': 'bp', 'g7': 'bp', 'h7': 'bp',
                    'a8': 'b' + split[0], 'b8': 'b' + split[1], 'c8': 'b' + split[2], 'd8': 'b' + split[3], 'e8': 'b' + split[4], 'f8': 'b' + split[5], 'g8': 'b' + split[6], 'h8': 'b' + split[7]
                }
            }
